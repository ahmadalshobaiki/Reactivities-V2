...
builder.Services.AddIdentityApiEndpoints<User>(opt =>
{
    ...
    opt.SignIn.RequireConfirmedEmail = true; // requires email confirmation during onboarding or else return 401 - unauthorized if the user logs in without verifying their email
