...
// make this component an observer to our MobX cache (Which is the activityStore in this case) to observe changes in the filter or startDate properties (which is changed by another observer component: ActivityFilter)
