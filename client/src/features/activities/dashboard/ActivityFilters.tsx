...
// make this component an updater to our activity store (Which is a Mobx cache for client side state management) to make changes in the filter or startDate properties
const ActivityFilters = observer(function ActivityFilters() {

    // Hook for the ActivityFilter to obtain MobX cache values for updating
